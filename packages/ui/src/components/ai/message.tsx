...
export const AIMessageContent = ({
  ...
  <div
    className={cn(
      ...
      "group-[.is-user]:border-transparent group-[.is-user]:bg-gradient-to-b group-[.is-user]:from-primary group-[.is-user]:to-[#21CA90] group-[.is-user]:text-primary-foreground group-[.is-user]:text-white",
      className
    )}
    {...props}
  >
